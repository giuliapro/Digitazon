...
function getLegalMove(chessboard, position) {
  ...
  let key = pezzo.substring(1) // metodo che serve per dire che deve considerare
  // i valori di tutti gli indici dopo lo 0, quindi da 1 in poi
  let legal = map[key] // variabile per invocare la funzione
  return legal(chessboard, position) // invoco
}
